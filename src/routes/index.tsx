        ...
        <div className="mt-12 grid gap-10 md:grid-cols-3">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm text-cream/70">
              ...
              <li><a href="/reembolso-trocas-e-devolucoes" className="hover:text-gold">Reembolso e trocas</a></li>
              <li><a href="/frete-e-entrega" className="hover:text-gold">Frete e entrega</a></li>
            </ul>
          </div>
        </div>
      </div>
