    ...
    <section class="px-4 py-6 max-w-6xl mx-auto">
        <div class="flex flex-col md:flex-row gap-8">
            ...
            <div class="w-full md:w-1/2 flex flex-col">
                ...
                <!-- Trust Badges Updated with stable sources -->
                <div class="mt-8 pt-6 border-t flex flex-wrap items-center justify-center gap-x-5 gap-y-3 opacity-90">
                    ...
                    <img src="https://seeklogo.com/images/E/elo-logo-0B5C45ED9E-seeklogo.com.png" alt="Elo" class="h-5 w-auto object-contain">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/a/a2/Logo%E2%80%94Pix.svg" alt="Pix" class="h-5 w-auto object-contain">
...
"""
    with open('sonolift-shopify-v34.html', 'w', encoding='utf-8') as f:
        f.write(html)
