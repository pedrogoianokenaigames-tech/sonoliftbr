...
<body>
    ...
    <nav class="bg-white border-b px-4 py-4 flex justify-between items-center">
        <div class="w-10"></div>
        <div class="font-display text-3xl text-center w-full">SonoLift<span class="text-[#C5A059]">™</span></div>
        <div class="w-10"></div>
    </nav>
    ...
    <section class="px-4 py-6 max-w-6xl mx-auto">
        <div class="flex flex-col md:flex-row gap-8">
            ...
            <div class="w-full md:w-1/2 flex flex-col">
                ...
                <!-- Trust Badges -->
                <div class="mt-8 pt-6 border-t flex flex-wrap items-center justify-center gap-x-5 gap-y-3 grayscale opacity-60">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/5/5e/Visa_Inc._logo.svg" alt="Visa" class="h-4 w-auto object-contain">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/2/2a/Mastercard-logo.svg" alt="Mastercard" class="h-5 w-auto object-contain">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/d/d1/Elo_logo.svg" alt="Elo" class="h-4 w-auto object-contain">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/a/a2/Logo%E2%80%94Pix.svg" alt="Pix" class="h-4 w-auto object-contain">
                    ...
                    <div class="flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-widest">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="h-3.5 w-3.5">
                            <rect x="5" y="10" width="14" height="11" rx="2" /><path d="M7 10V7a5 5 0 0 1 10 0v3h-2V7a3 3 0 0 0-6 0v3H7Z" />
                        </svg>
                        Seguro
                    </div>
                </div>
...
"""
    with open('sonolift-shopify-v32.html', 'w', encoding='utf-8') as f:
        f.write(html)
