    ...
    <section class="px-4 py-6 max-w-6xl mx-auto">
        <div class="flex flex-col md:flex-row gap-8">
            ...
            <div class="w-full md:w-1/2 flex flex-col">
                ...
                <!-- Trust Badges Fixed with reliable PNG sources -->
                <div class="mt-8 pt-6 border-t flex flex-wrap items-center justify-center gap-x-5 gap-y-3 opacity-90">
                    <img src="https://raw.githubusercontent.com/a-bentley/payment-icons/master/png/visa.png" alt="Visa" class="h-5 w-auto object-contain">
                    <img src="https://raw.githubusercontent.com/a-bentley/payment-icons/master/png/mastercard.png" alt="Mastercard" class="h-6 w-auto object-contain">
                    <img src="https://raw.githubusercontent.com/a-bentley/payment-icons/master/png/elo.png" alt="Elo" class="h-5 w-auto object-contain">
                    <img src="https://raw.githubusercontent.com/a-bentley/payment-icons/master/png/pix.png" alt="Pix" class="h-5 w-auto object-contain">
...
"""
    with open('sonolift-shopify-v35.html', 'w', encoding='utf-8') as f:
        f.write(html)
