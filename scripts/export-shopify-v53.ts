...
<head>
  ...
  <script>
    tailwind.config = {
      theme: {
        extend: {
          colors: { gold: '#D4AF37', 'midnight-deep': '#0B1B3B', cream: '#FCF9F2', border: '#e8e2d2' },
  ...
  <main>
    <section id="oferta" class="py-10 px-4 max-w-6xl mx-auto grid md:grid-cols-2 gap-10">
      <div class="hero-gallery bg-white rounded-3xl p-4 shadow-xl">
        ...
        <div class="flex gap-2 mt-4 overflow-x-auto pb-2">
            ...
            <img onclick="document.getElementById('mainImage').src=this.src" src="${resolveAsset('/lovable-uploads/5341f237-7f61-4560-93a5-117565c69781.png')}" class="w-16 h-16 rounded-lg border cursor-pointer">
        </div>
      </div>
      ...
      <div>
        <div class="mt-6 flex flex-col items-center sm:items-start">
            ...
            <div class="flex items-center gap-3">
              ...
              <span class="rounded bg-gold px-2 py-0.5 text-[10px] font-black uppercase tracking-widest text-midnight-deep shadow-sm">GRÁTIS</span>
            </div>
            
            <div class="mt-4 flex flex-col items-center sm:items-start">
              <p class="text-[13px] text-gray-500 font-medium">Valor total: <span class="line-through decoration-red-600 decoration-1 opacity-70">R$ 397</span></p>
              ...
              <p class="mt-1 text-[13px] text-midnight-deep font-medium opacity-90">Em até <strong class="text-gold">12x de R$ 16,42</strong> sem juros</p>
            </div>
        </div>

        <div class="mt-6 bg-amber-50 border border-amber-200 p-3 rounded-xl text-center font-bold text-amber-900 text-sm">🎁 OFERTA: Kit Rosto + Kit Colo GRÁTIS</div>

        <a href="https://sono-lift.pay.yampi.com.br/r/R558X0P2M5" class="block mt-6 bg-gold-gradient text-midnight-deep text-center py-5 rounded-full font-black text-lg shadow-xl hover:scale-105 transition">GARANTIR MEU KIT + COLO GRÁTIS →</a>
        ...
        <div class="mt-6 flex flex-col items-center justify-center gap-4 sm:flex-row sm:justify-start">
            <div class="flex items-center gap-2 text-[13px] font-bold uppercase tracking-wider text-midnight-deep opacity-90">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="h-4 w-4 text-gold"><path d="M12 2C9.243 2 7 4.243 7 7V10H6C4.895 10 4 10.895 4 12V20C4 21.105 4.895 22 6 22H18C19.105 22 20 21.105 20 20V12C20 10.895 19.105 10 18 10H17V7C17 4.243 14.757 2 12 2ZM9 7C9 5.346 10.346 4 12 4C13.654 4 15 5.346 15 7V10H9V7ZM12 17C11.172 17 10.5 16.328 10.5 15.5C10.5 14.672 11.172 14 12 14C12.828 14 13.5 14.672 13.5 15.5C13.5 16.328 12.828 17 12 17Z" /></svg>Compra 100% Segura
            </div>
        </div>
    ...
    <section class="bg-midnight-deep text-white py-16 px-4">
      <div class="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 text-center reveal">
        <div><div class="text-4xl font-black text-gold">97%</div><p class="text-xs uppercase mt-2">Pele mais lisa</p></div>
        <div><div class="text-4xl font-black text-gold">92%</div><p class="text-xs uppercase mt-2">Menos rugas</p></div>
        <div><div class="text-4xl font-black text-gold">88%</div><p class="text-xs uppercase mt-2">Colo hidratado</p></div>
        <div><div class="text-4xl font-black text-gold">95%</div><p class="text-xs uppercase mt-2">Recomendariam</p></div>
      </div>
    </section>
  </main>
    ...
    <div class="max-w-6xl mx-auto px-4 pb-12">
        <div class="grid gap-10 md:grid-cols-3">
          <div>
            ...
            <p class="mt-3 max-w-sm text-sm opacity-70">Sistema de proteção contra as rugas do sono. Silicone médico de alta performance.</p>
          </div>
          <div>
    ...
    <div class="border-t border-white/10 py-8">
        <div class="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4 text-xs opacity-60">
            ...
            <div class="flex items-center justify-center gap-2">
                <div class="dot-indicator dot-small-white"></div><div class="dot-indicator dot-small-white"></div><div class="dot-indicator dot-large-gold"></div><div class="dot-indicator dot-small-white"></div>
            </div>
        </div>
    </div>
  </footer>

  <div id="stickyCTA" class="fixed bottom-0 left-0 w-full bg-white border-t p-3 z-[100] transition-transform translate-y-full md:hidden shadow-[0_-8px_30px_rgba(0,0,0,0.12)]">
    <a href="https://sono-lift.pay.yampi.com.br/r/R558X0P2M5" class="block bg-gold-gradient text-midnight-deep text-center py-4 px-2 rounded-full font-black text-sm uppercase tracking-wide shadow-lg">GARANTIR MEU KIT + COLO GRÁTIS →</a>
  </div>
  ...
  <script>
    ...
    window.onload = function () {
      ...
      window.addEventListener('scroll', function() {
        if (window.scrollY > 600) sticky.style.transform = 'translateY(0)';
