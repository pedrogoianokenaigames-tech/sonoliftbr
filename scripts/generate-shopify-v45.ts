    ...
    <div class="min-h-screen bg-[#fdfaf5] text-[#1a1a2e] pb-[80px] md:pb-0">
        ...
        <div class="mx-auto max-w-6xl flex flex-col md:flex-row md:gap-12">
          ...
          <div class="w-full md:w-1/2">
            <div class="relative aspect-square w-full overflow-hidden rounded-2xl bg-white shadow-soft max-h-[50vh] sm:max-h-[550px] md:max-h-none">
              <img id="main-hero-img" src="${DOMAIN}/__l5e/assets-v1/2566ecb8-15cf-4d9e-9d22-6b5e09f58356/hero1.webp" alt="Produto" class="h-full w-full object-contain p-2 sm:p-4">
            </div>
            <div class="mt-4 flex gap-2.5 overflow-x-auto pb-2 scrollbar-hide sm:grid sm:grid-cols-6 sm:overflow-visible">
              <div onclick="document.getElementById('main-hero-img').src='${DOMAIN}/__l5e/assets-v1/2566ecb8-15cf-4d9e-9d22-6b5e09f58356/hero1.webp'" class="relative aspect-square w-16 min-w-[64px] cursor-pointer rounded-lg border-2 border-[#d4af37] bg-white"><img src="${DOMAIN}/__l5e/assets-v1/2566ecb8-15cf-4d9e-9d22-6b5e09f58356/hero1.webp" class="h-full w-full object-cover rounded-lg"></div>
              <div onclick="document.getElementById('main-hero-img').src='${DOMAIN}/__l5e/assets-v1/9a4192b6-5f1e-4ce2-b062-673ebf156cd4/hero2.jpg'" class="relative aspect-square w-16 min-w-[64px] cursor-pointer rounded-lg border-2 border-transparent bg-white opacity-60"><img src="${DOMAIN}/__l5e/assets-v1/9a4192b6-5f1e-4ce2-b062-673ebf156cd4/hero2.jpg" class="h-full w-full object-cover rounded-lg"></div>
              <div onclick="document.getElementById('main-hero-img').src='${DOMAIN}/__l5e/assets-v1/053b1156-32d8-4f16-bd09-54b9d07f35a0/hero3.jpg'" class="relative aspect-square w-16 min-w-[64px] cursor-pointer rounded-lg border-2 border-transparent bg-white opacity-60"><img src="${DOMAIN}/__l5e/assets-v1/053b1156-32d8-4f16-bd09-54b9d07f35a0/hero3.jpg" class="h-full w-full object-cover rounded-lg"></div>
              <div onclick="document.getElementById('main-hero-img').src='${DOMAIN}/__l5e/assets-v1/b8559197-243e-425b-ae49-6234f9a0b1cc/hero4.jpg'" class="relative aspect-square w-16 min-w-[64px] cursor-pointer rounded-lg border-2 border-transparent bg-white opacity-60"><img src="${DOMAIN}/__l5e/assets-v1/b8559197-243e-425b-ae49-6234f9a0b1cc/hero4.jpg" class="h-full w-full object-cover rounded-lg"></div>
              <div onclick="document.getElementById('main-hero-img').src='${DOMAIN}/__l5e/assets-v1/1852077e-2cf8-410a-8664-968b6b0d9c49/hero5.webp'" class="relative aspect-square w-16 min-w-[64px] cursor-pointer rounded-lg border-2 border-transparent bg-white opacity-60"><img src="${DOMAIN}/__l5e/assets-v1/1852077e-2cf8-410a-8664-968b6b0d9c49/hero5.webp" class="h-full w-full object-cover rounded-lg"></div>
              <div onclick="document.getElementById('main-hero-img').src='${DOMAIN}/__l5e/assets-v1/c768903c-e674-4b47-b391-9e5fa4189cc3/hero6.jpg'" class="relative aspect-square w-16 min-w-[64px] cursor-pointer rounded-lg border-2 border-transparent bg-white opacity-60"><img src="${DOMAIN}/__l5e/assets-v1/c768903c-e674-4b47-b391-9e5fa4189cc3/hero6.jpg" class="h-full w-full object-cover rounded-lg"></div>
            </div>
          </div>
          <!-- Content -->
          <div class="mt-8 md:mt-0 md:w-1/2">
            ...
            <div class="mt-8 flex flex-wrap items-center justify-center gap-x-6 gap-y-4 border-t border-black/10 pt-6">
              <img src="https://img.icons8.com/color/48/visa.png" class="h-6 w-auto object-contain">
              <img src="https://img.icons8.com/color/48/mastercard.png" class="h-8 w-auto object-contain">
              <img src="${DOMAIN}/__l5e/assets-v1/450cf449-62f4-4a4b-8422-9596c56858e7/elo-logo.jpg" class="h-6 w-auto object-contain">
              <img src="${DOMAIN}/__l5e/assets-v1/095b5465-9831-4821-b3b3-85f0962b9a78/pix-logo.png" class="h-6 w-auto object-contain">
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="bg-[#fdfaf5] py-20 px-4 reveal">
        <div class="mx-auto max-w-6xl text-center">
          ...
          <h2 class="font-display text-4xl text-[#1a1a2e] sm:text-5xl md:text-6xl">Acorde sem as <em class="italic text-[#d4af37]">marcas</em> do travesseiro.</h2>
          <div class="relative mt-12 aspect-[9/16] w-full max-w-[380px] mx-auto rounded-[2.5rem] bg-black shadow-luxe overflow-hidden">
             <video src="${DOMAIN}/__l5e/assets-v1/ffe73f55-6f15-44c5-ba81-1e8528f04917/hero-video-2.mp4" autoplay loop muted playsinline class="h-full w-full object-contain"></video>
          </div>
        </div>
      </section>

      <!-- Testimonials -->
      <section class="bg-white py-20 px-4 reveal">
        <div class="mx-auto max-w-6xl text-center">
           <h2 class="font-display text-3xl">O que elas estão dizendo...</h2>
           <div class="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
             <video src="${DOMAIN}/__l5e/assets-v1/867118ed-738b-4916-a70d-587208ed08f0/ugc1.mp4" controls class="rounded-2xl shadow-soft"></video>
             <video src="${DOMAIN}/__l5e/assets-v1/93d18306-3843-4a16-92c2-8097b3997e37/ugc2.mp4" controls class="rounded-2xl shadow-soft"></video>
             <video src="${DOMAIN}/__l5e/assets-v1/b8d65a88-6623-4557-9d62-10651912d6a5/ugc3.mp4" controls class="rounded-2xl shadow-soft"></video>
             <video src="${DOMAIN}/__l5e/assets-v1/788c0347-16cc-463e-ac31-5079a4e3264b/ugc4.mp4" controls class="rounded-2xl shadow-soft"></video>
           </div>
        </div>
      </section>
      ...
      <section class="bg-[#fdfaf5] py-20 px-4 reveal">
        <div class="mx-auto max-w-3xl rounded-3xl bg-midnight-gradient p-8 text-white shadow-luxe md:p-12">
          ...
          <div class="mt-8 text-center">
            ...
            <p class="font-display text-6xl font-semibold text-[#d4af37]">R$ 197</p>
          </div>
          <div class="mt-8">
